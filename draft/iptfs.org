...
*** IKEv2 IP-TFS Supported Payload Type (TBD2)

The following defines the IP-TFS supported payload IPTFS_SUPPORT (TBD2).
...
** IPTFS_SUPPORT IKEv2 Payload Type

Additionally this document requests an IKEv2 payload type
IPTFS_SUPPORT (TBD2) be allocated by IANA from "IKEv2 Payload Types"
registry.
